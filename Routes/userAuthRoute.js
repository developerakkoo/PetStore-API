 ...
 * 
 */
router.post('/user/loginauth',  UserAuthController.loginUser);//changed login to loginauth because same route is for user  
 ...
 * 
 */
router.post('/user/registration',  UserAuthController.postSignup);//changed register to registration because same route is for user
